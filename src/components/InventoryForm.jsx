...
import inventory1 from "../../assets/inventory_images/inventory1.jpg"
const InventoryForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(http://localhost:5000/inventory/addin, newMedicine)
            .then(() => {
    ...
    return (
        <div 
            ...
            style={{
                backgroundImage: url(${inventory1}), // Fixed template literal
                backgroundSize: "cover",
                backgroundPosition: "center",
                backgroundRepeat: "no-repeat"
            }}
>
            <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md opacity-90">
