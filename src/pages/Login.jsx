...
const Login = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-white via-blue-50 to-blue-100">
      <Navbar />
        ...
        <div className="p-8">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex space-x-2">
              <button
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${state === 'Sign Up' ? 'bg-blue-500 text-white' : 'text-gray-500 hover:bg-blue-50'}`}
                onClick={() => setState('Sign Up')}
              >
                Sign Up
              </button>
              <button
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${state === 'Login' ? 'bg-blue-500 text-white' : 'text-gray-500 hover:bg-blue-50'}`}
          ...
          <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-800 mb-2">
